...
class UnitResidentsScreen extends ConsumerStatefulWidget {
  final Unit unit;
  final String condominiumId;
  final Condominium? condominium;

  const UnitResidentsScreen({
    super.key,
    required this.unit,
  ...
  @override
  ConsumerState<UnitResidentsScreen> createState() => _UnitResidentsScreenState();
}

class _UnitResidentsScreenState extends ConsumerState<UnitResidentsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Residentes - ${_getBlockName()} ${_currentUnit.name}'),
        leading: IconButton(
